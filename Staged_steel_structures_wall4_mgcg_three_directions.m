...
act_wall4 = elmNrs(1:77,1:nelz-7,1:wall_width);
act_wall = reshape(act_wall4,[],1);

door_width = round(800 / 9000 * 384);
door_height = round(2000 / 3000 * 128);

pasV_door2_x_1 = 1;
pasV_door2_x_2 = wall_width;
pasV_door2_y_1 = round(767 / 3000 * nely + 1);
pasV_door2_y_2 = round(767 / 3000 * nely + door_width);

pasV_door2 = elmNrs(pasV_door2_y_1:pasV_door2_y_2, 1: door_height, pasV_door2_x_1: pasV_door2_x_2);
pasV_door = reshape(pasV_door2, [], 1);

intersection = intersect(act_wall, pasV_door);
act_wall = setdiff(act_wall, intersection);
pasS_wall3_1 = elmNrs(1:77,1:nelz-7,1);
pasS_wall3_2 = elmNrs(1:77,1:nelz-7,13);
pasS_wall = union(pasS_wall3_1, pasS_wall3_2);
...
filename = 'xphys_wall_4_data.mat';
...
savefig(strcat('QNC_V1_staged_wall4_',num2str(loop),'.fig'));
%end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

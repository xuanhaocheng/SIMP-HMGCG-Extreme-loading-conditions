...
act_wall3 = elmNrs(1:wall_width,1:nelz-7,1:140);
act_wall = reshape(act_wall3,[],1);

door_width = round(1000 / 9000 * 384);
door_height = round(2000 / 3000 * 128);

pasV_door3_x_1 = round(1856.76 / 6000 * nelx + 1);
pasV_door3_x_2 = round(1856.76 / 6000 * nelx + door_width);
pasV_door3_y_1 = 1;
pasV_door3_y_2 = wall_width;

pasV_door3 = elmNrs(pasV_door3_y_1:pasV_door3_y_2, 1: door_height, pasV_door3_x_1: pasV_door3_x_2);
pasV_door = reshape(pasV_door3, [], 1);

intersection = intersect(act_wall, pasV_door);
act_wall = setdiff(act_wall, intersection);

pasS_wall3_1 = elmNrs(1,1:nelz-7,1:140);
pasS_wall3_2 = elmNrs(13,1:nelz-7,1:140);
...
filename = 'xphys_wall_3_data.mat';
...
savefig(strcat('QNC_V1_staged_wall3_',num2str(loop),'.fig'));
%end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

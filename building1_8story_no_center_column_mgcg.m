...
lcDof1 = 3 * nodeNrs( nely/16+1 : 15/16*nely + 1,  nelz/2+1,nelx/16+1 : 15/16*nelx + 1 ); %[nelz/2+18,
lcDof2 = 3 * nodeNrs(nely/16+1 : 15/16*nely + 1,  nelz+1, nelx/16+1 : 15/16*nelx + 1 );
lcDof3 = 3 * nodeNrs(nely/16+1 : 15/16*nely + 1,  nelz/4+1, nelx/16+1 : 15/16*nelx + 1 ); %[nelz/2+18,
lcDof4 = 3 * nodeNrs( nely/16+1 : 15/16*nely + 1,  nelz*3/4+1, nelx/16+1 : 15/16*nelx + 1 ); %[nelz/2+18,
lcDof5 = 3 * nodeNrs(nely/16+1 : 15/16*nely + 1,  nelz/8+1, nelx/16+1 : 15/16*nelx + 1 ); %[nelz/2+18,
lcDof6 = 3 * nodeNrs(nely/16+1 : 15/16*nely + 1,  nelz*3/8+1, nelx/16+1 : 15/16*nelx + 1);
lcDof7 = 3 * nodeNrs(nely/16+1 : 15/16*nely + 1,  nelz*5/8+1, nelx/16+1 : 15/16*nelx + 1); %[nelz/2+18,
lcDof8 = 3 * nodeNrs(nely/16+1 : 15/16*nely + 1,  nelz*7/8+1,nelx/16+1 : 15/16*nelx + 1 ); %[nelz/2+18,
...
pasV=elmNrs(nely/16+1:nely-nely/16,[1:nelz/8-zzz,nelz/8+1:nelz/4-zzz,nelz/4+1: nelz*3/8-zzz,nelz*3/8+1:nelz/2-zzz,...
    nelz/2+1:nelz*5/8-zzz,nelz*5/8+1:nelz*3/4-zzz,nelz*3/4+1: nelz*7/8-zzz,nelz*7/8+1:nelz-zzz],nelx/16+1:nelx-nelx/16);
pasS =  reshape(elmNrs(nely/16+1:nely-nely/16,[nelz/8,nelz/4,nelz*3/8,nelz/2,...
...
filename = 'xphys_no_column_data.mat';
...
patch(isosurface(isovals, .3),'FaceColor',[192, 192, 192]/255,'EdgeColor','none'); %'b'
patch(isocaps(isovals, .3),'FaceColor','r','EdgeColor','none');

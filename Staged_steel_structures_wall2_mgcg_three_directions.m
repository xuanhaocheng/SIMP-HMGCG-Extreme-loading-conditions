...
act_wall2 = elmNrs(1:wall_width,1:nelz-7,1:123);
act_wall = reshape(act_wall2,[],1);
...
pasS_wall1_1 = elmNrs(1,1:nelz-7,1:123);
pasS_wall1_2 = elmNrs(13,1:nelz-7,1:123);
...
filename = 'xphys_wall_2_data.mat';
...
savefig(strcat('QNC_V1_staged_wall2_',num2str(loop),'.fig'));
%end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

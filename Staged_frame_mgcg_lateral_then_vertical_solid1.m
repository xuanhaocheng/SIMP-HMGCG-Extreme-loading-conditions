...
filePath = 'xphys_frame_data_8_solid.mat'; 
% Load data from. mat file
xPhys_0 = load(filePath);
xPhys_1 = xPhys_0.xPhys;
% Find the index of values greater than 0.5 in xphys
pasS_0 = find(xPhys_1 > 0.5); %disp pasS matrix
% isovals = shiftdim( reshape( xPhys_1, nely, nelz, nelx ), 2 );
...
pasS = double(union(pasS_0,pasSS1));
...
filename = 'xphys_frame_data_8_vertical_solid.mat';

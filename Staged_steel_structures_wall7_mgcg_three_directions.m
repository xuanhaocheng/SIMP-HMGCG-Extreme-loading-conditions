...
act_wall7 = elmNrs(1:148,1:nelz-7,1:wall_width);
act_wall = reshape(act_wall7,[],1);

pasS_wall7_1 = elmNrs(1:148,1:nelz-7,1);
pasS_wall7_2 = elmNrs(1:148,1:nelz-7,13);
pasS_wall = union(pasS_wall7_1, pasS_wall7_2);
...
filename = 'xphys_wall_7_data.mat';
...
savefig(strcat('QNC_V1_staged_wall7_',num2str(loop),'.fig'));
%end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

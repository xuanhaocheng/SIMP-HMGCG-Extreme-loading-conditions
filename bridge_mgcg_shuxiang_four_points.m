...
% fixed1=3*nodeNrs( 1:nely+1, 1, [1:4,nelx+1-4:nelx+1])-2;
% fixed2=3*nodeNrs( 1:nely+1, 1, [1:4,nelx+1-4:nelx+1])-1;
% fixed3=3*nodeNrs( 1:nely+1, 1, [1:4,nelx+1-4:nelx+1]);
...
Assembly_F0_1(F0,pasS, cVec,g4, nelx, nely, nelz,direction3);   

...
z1 = round(nelz*5/12);
z2 = round(nelz*7/12 + 1);
x1 = round(nelx*1/3 + 1);
pasV1=elmNrs(:,[1:z1,z2:nelz],x1:nelx);
...
F = zeros(nDof,1);
direction3 = 3;
lcDof1 = 3 * nodeNrs( 1:nely+1, nelz+1, x1)-2;
lcDof11 = 3 * nodeNrs( 1 : nely + 1, z2, nelx + 1 );
force1 = 50.0 / 1.0;
force2 = 1.0;
...
savefig(strcat('QNC_V1_test_T_beam_',num2str(mm),'_',num2str(force1 / force2),'_',num2str(loop),'.fig'));
%end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

...
act_wall6 = elmNrs(1:77,1:nelz-7,1:wall_width);
act_wall = reshape(act_wall6,[],1);
pasS_wall6_1 = elmNrs(1:77,1:nelz-7,1);
pasS_wall6_2 = elmNrs(1:77,1:nelz-7,13);
pasS_wall = union(pasS_wall6_1, pasS_wall6_2);
...
filename = 'xphys_wall_6_data.mat';
...
savefig(strcat('QNC_V1_staged_wall6_',num2str(loop),'.fig'));
%end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
